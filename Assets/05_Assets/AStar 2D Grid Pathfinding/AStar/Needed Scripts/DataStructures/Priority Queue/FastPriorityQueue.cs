...
namespace Priority_Queue
{
        ...
        where T : FastPriorityQueueNode
    {
        ...
        private void CascadeDown(T node)
        {
            ...
            // Check if the left-child is higher-priority than the present node
            ...
            {
                // Check if the right-child is higher-priority than the present node
                T childRight = _nodes[childRightIndex];
                ...
                // Neither child is higher-priority than present, so finish and stop.
                else
                {
                    return;
                }
        ...
        /// <summary>
        /// Resize the queue so it can accept more nodes.  All presently enqueued nodes are remain.
        ...
        public void Resize(int maxNodes)
        {
            ...
            {
                throw new InvalidOperationException("Called Resize(" + maxNodes + "), but present queue contains " + _numNodes + " nodes");
            }
#endif
        ...
        /// If the node is presently in the queue or belongs to another queue, the result is undefined
        /// </summary>
#if NET_VERSION_4_5
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
